...
<div class="container-fluid">
	...
	<div class="row">
	    <div class="col-lg-12">
	        <ol class="breadcrumb">
	            <li class="active">
	                <i class="fa fa-dashboard"></i> 内容类型管理
	            </li>
	        </ol>
	    </div>
	</div>
	<!-- /.row -->
 	  ...
 	  <div class="col-lg-12">
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo U('Content/addCTM');?>"><i class="glyphicon glyphicon-plus"></i> 添加内容模型</a>
            </li>
        </ol>
      </div>
	  <div class="col-lg-12">
	      <div class="table-responsive">
	          <table class="table table-bordered table-hover table-striped">
	              ...
	              <tbody>
	                 <?php if(is_array($ctmlist)): foreach($ctmlist as $key=>$vo): ?><tr>
	                      <td><?php echo ($key + 1); ?></td>
	                      <td><?php echo ($vo["name"]); ?></td>
	                      <td><?php echo ($vo["description"]); ?></td>
	                      <td><?php echo ($vo["logicname"]); ?>Logic.class.php</td>
	                      <td>
	                      <a href="<?php echo U('Content/editCTM',array('id'=>$vo['id']));?>"><span>编辑</span></a>
	                      </td>
	                      <td><?php if($vo['is_active'] == 1): ?>使用中<?php else: ?>停止<?php endif; ?></td>
