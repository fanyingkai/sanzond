...
<div class="container-fluid">
	...
	<div class="row">
	    <div class="col-lg-12">
	        <ol class="breadcrumb">
	            <li class="active">
	                <i class="fa fa-dashboard"></i> 轮播图列表
	            </li>
	        </ol>
	    </div>
	</div>
 	  ...
 	  <div class="col-lg-12">
        <ol class="breadcrumb">
            <li>
                <a href="<?php echo U('Content/ctmdisplay',array('logic'=>'banner','action'=>'add'));?>"><i class="glyphicon glyphicon-plus"></i> 添加轮播图</a>
            </li>
        </ol>
      </div>
	  <div class="col-lg-12">
	      <div class="table-responsive">
	          <table class="table table-bordered table-hover table-striped">
	              ...
	              <tbody>
	                 <?php if(is_array($listbanner)): foreach($listbanner as $key=>$vo): ?><tr>
	                      <td><?php echo ($key + 1); ?></td>
	                      <td><?php echo ($vo["name"]); ?></td>
	                      <td><?php echo ($vo["description"]); ?></td>
	                      <td><img src="/Uploads/<?php echo ($vo["img_url"]); ?>" style="width:38px;height:20px"/></td>
	                      <td><?php if($vo['is_active'] == 1): ?>可用<?php else: ?>不可用<?php endif; ?></td>
	                      <td>
	                      <a href="<?php echo U('Content/ctmdisplay',array('logic'=>'banner','action'=>'edit','id'=>$vo['id']));?>"><span>编辑</span></a> 
	                      <a href="javascript:delctm('banner','<?php echo ($vo["id"]); ?>');">删除</a>
	                      </td>
