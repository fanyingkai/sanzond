...
<body>
	...
	<div class="row">
		  <div class="col-lg-12">
	        <ol class="breadcrumb">
	            <li>
	                <a href="<?php echo U('User/addgroup');?>"><i class="glyphicon glyphicon-plus"></i>添 加 用 户 分 类</a>
	            </li>
	        </ol>
	      </div>
		  <div class="col-lg-12">
		      ...
		      <div class="table-responsive">
		          <table class="table table-bordered table-hover table-striped">
		              ...
		              <tbody>
		                 <?php if(is_array($grouplist)): foreach($grouplist as $key=>$vo): ?><tr <?php if($vo['status'] != 1 ): ?>class="danger"<?php endif; ?>>
		                      ...
		                      <td>
		                      <a href="<?php echo U('User/editgroup',array('id'=>$vo['id']));?>"><span>编辑</span></a> | 
		                      <span>删除 </span>
		                      </td>
