...
<body>
	...
	<div class="row">
		  <div class="col-lg-12">
	        <ol class="breadcrumb">
	            <li>
	                <a href="<?php echo U('User/addrule');?>"><i class="glyphicon glyphicon-plus"></i>添 加 规 则</a>
	            </li>
	        </ol>
	      </div>
		  <div class="col-lg-12">
		      <div class="table-responsive">
		          <table class="table table-bordered table-hover table-striped">
		              ...
		              <tbody>
		                 <?php if(is_array($rulelist)): foreach($rulelist as $key=>$vo): ?><tr <?php if($vo['status'] == 0 ): ?>class="danger"<?php endif; ?>>
		                      <td><?php $s=intval(I('p','1')); echo ((($s - 1) * 15) + ($key + 1));?></td>
		                      <td><?php echo ($vo["title"]); ?></td>
		                      <td><?php echo ($vo["name"]); ?></td>
		                      <td><?php echo ($vo["condition"]); ?></td>
		                      <td><?php if($vo['status'] == 1 ): ?>是
		                      		<?php else: ?> 否<?php endif; ?>
		                      </td>
		                      <td>
		                      <a href="<?php echo U('User/editrule',array('id'=>$vo['id']));?>"><span>编辑</span></a> | 
		                      <span>删除 </span>
		                      </td>
