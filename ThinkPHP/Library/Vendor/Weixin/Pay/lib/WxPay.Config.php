...
//商户基本信息
defined('APPID') || define('APPID','wxd530b6a24f4a7983');//APPID
defined('MCHID') || define('MCHID', '1361650602');//商户号
defined('KEY') || define('KEY', 'sYErx2Lq6oQi1ao9DaMnIhGKHaaeSSw2');//密钥
defined('APPSECRET') || define('APPSECRET', 'f6b280621f32b034654750991505bbec');//appsecret
